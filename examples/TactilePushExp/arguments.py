...
def get_rl_parser():
    ...
    parser.add_argument(
        '--cfg', type=str, default='./cfg/TactilePush/ppo_tactile.yaml',
...
def get_gd_parser():
    parser = argparse.ArgumentParser(description='GD')
    
    parser.add_argument(
        '--cfg', type=str, default='./cfg/Insertion-v1/gd.yaml',
        help='specify the config file for the run'
    )
    ...
    parser.add_argument(
        ...
        help="whether render during evaluation"
    )
...
def get_sl_parser():
    ...
    parser.add_argument(
        '--cfg', type=str, default='./cfg/TactilePush/gd_tactile.yaml',
        help='specify the config file for the run'
    )
    ...
    parser.add_argument(
        ...
        help="interval between two policy evaluation"
    )
